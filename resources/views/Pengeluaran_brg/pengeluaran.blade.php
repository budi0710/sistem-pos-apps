                    ...
                    <tbody>
                        <tr v-for="data in h_btbgs" class="align-middle">
                            ...
                            <td>
                                ...
                                <button @click="editPage(data.fno_btbg)" class="btn btn-primary">Pengeluaran Brg</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
const $app =   new Vue({
        ...
        methods:{
            editPage: function(fno_btbg){
                    window.location.href="./edit-btbg/"+fno_btbg;
                },
